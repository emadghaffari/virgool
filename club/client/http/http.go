...
import (
	...
	"context"
	"encoding/json"
	endpoint1 "github.com/emadghaffari/virgool/club/pkg/endpoint"
	http2 "github.com/emadghaffari/virgool/club/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.ClubService, error) {
